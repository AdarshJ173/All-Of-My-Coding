...
'''
In python, variables can be defined at the class level or at the instance level. Understanding the difference between these types of vaiable is crucial for writing efficient and maintaining code.
...
class Employee:
    ...
    def showDetails(self):
        print(f"The name of the employee is {self.name} and the raise amount in {self.noOFEmployee} sized {self.compName} is {self.raise_amount}")



emp1 = Employee("Adarsh")
# print(emp1.showDetails())
emp1.raise_amount = 0.3
emp1.compName = "AAJ_IND"
emp1.showDetails()
